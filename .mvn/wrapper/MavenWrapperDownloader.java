...
public class MavenWrapperDownloader {
    ...
    public static void main(String[] args) {
        ...
        logger.log("- Using base directory: " + baseDirectory.getAbsolutePath());
        ...
        if (mavenWrapperPropertyFile.exists()) {
            ...
            try {
                ...
                logger.log("- ERROR loading '" + MAVEN_WRAPPER_PROPERTIES_PATH + "'");
            } finally {
                try {
        ...
        logger.log("- Downloading to: " + outputFile.getAbsolutePath());
        try {
